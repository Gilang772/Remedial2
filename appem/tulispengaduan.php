...
<div class="form-group col-sm-6">
				...
				<input type="file" name="foto"class="form-control"accept=".jpg,.jpeg,.png,.gif"><font color="red">*tipe yang bisa di upload adalah : .jpg,.jpeg,.pbg,.gif</font>
				></div> 
<div class="form-group col-sm-6">
	<input type="submit" value="Simpan" class="btn-primary">
	<input type="reset" value="kosongkan" class="btn-warning">
